...
%define PAGE_DIRECTORY_BASE 0x00500000
%define PAGE_TABLES_BASE    0x00100000
...
create_page_directory:
    ...
    %assign i 0
    %rep    PAGES_COUNT
    page_directory_definition PAGE_TABLES_BASE + (i * 0x1000 + 0x0000), PAGE_DIRECTORY_BASE, i * 4
    %assign i i+1
    %endrep
