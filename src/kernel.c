...
int kmain() {
  ...
  //printf("/n===/n ====/n  =======/n   ===========----################*****++++===/n     ==============              +%%%%%%%%%%%%%%##**+==/n       =================         *%%%%%%%%%%%%%%%%%%%%%#*+=/n     =======================     *%%%%%%%%%%%%%%%%%%%%%%%%%#*=/n   ==----------------------------+############################*=   ====    ====/n  ===============================+##############################++=    =++=    =/n  ==                             *%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%++=    =++=    =/n   ========                      +%%%%%%%%%%%%%%%%%%%%%%%%%%%%%+   ====    ====/n     +#%%%%%%####***====++++     *%%%%%%%%%%%%%%%%%%%%%%%%%%#*=/n        =*##%%%%%%%%%%%%%%%%%%%%#*%%%%%%%%%%%%%%%%%%%%%%##+=/n            ==+#************#%%%#*%%%%%%%%%%%%%%%%##*++=/n              +#-=         *#%%%*+#######***+++==/n              #+          ** =*#*     *#*/n             +#          =#=       =+##+/n             #+          *%#**#*###* ____   _____              _/n            *#          =#@=======  / __ \\ / ____|     (*)    | |/n           =#=          *=         | |  | | (___  _ __  _  ___| |__   _____   __/n           **          =#=         | |  | |\\___ \\| ._ \\| |/ __| ._ \\ / _ \\ \\ / //n          =#=          *=          | |__| |____) | |_) | | (__| | | |  __/\\ V //n          **          =#=           \\____/ \\____/| .__/|_|\\___|_| |_|\\___| \\_//n         *#==        =+#=                        | |/n         +*+*+++++++++**=                        |_|");
  infinite_loop
}
